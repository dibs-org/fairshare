...
export default function ReceiptPreviewCard({ receiptData, shareLink }: ReceiptPreviewCardProps) {
    ...
    >
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1f2937', marginBottom: '4px' }}>fairshare</h1>
          <p style={{ fontSize: '14px', color: '#4b5563' }}>because friends don't let friends do math</p>
        </div>
        ...
        <div style={{ marginBottom: '16px' }}>
          {topItems.map((item, index) => (
            <div key={item.id} style={{
              ...
              paddingBottom: '8px',
              borderBottom: index < topItems.length - 1 ? '1px solid #f3f4f6' : 'none'
            }}>
              <div style={{ flex: 1 }}>
          ...
          {remainingCount > 0 && (
            <p style={{ fontSize: '14px', color: '#6b7280', textAlign: 'center', paddingTop: '8px' }}>
        ...
        <div style={{ borderTop: '2px solid #e5e7eb', paddingTop: '16px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '18px', fontWeight: 'bold', color: '#1f2937', paddingTop: '8px', borderTop: '1px solid #e5e7eb', marginTop: '8px' }}>
            <span>Total</span>
        ...
        {/* CTA with QR Code */}
        <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '2px dashed #d1d5db', textAlign: 'center' }}>
          <div style={{ marginBottom: '16px' }}>
            {qrCodeDataUrl ? (
              <img 
                src={qrCodeDataUrl}
          ...
          <p style={{ fontSize: '14px', color: '#1f2937', fontWeight: '500', marginBottom: '4px' }}>
